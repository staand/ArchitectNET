namespace ArchitectNET.Core.Collections
{
    ...
    public interface IFixedList<TItem> : IFixedCollection<TItem>
    {
        ...
        /// <summary>
        /// Searches for the specified item and returns the zero-based index of the first occurrence within the range of items
        /// in the list that starts at the specified index and contains the specified number of items.
        /// </summary>
        ...
        /// <returns>
        /// The zero-based index of the first occurrence of <paramref name="item" /> within the range of items in the
        /// list that starts at <paramref name="startIndex" /> and contains <paramref name="maximumCount" /> number of items, if
        /// found; otherwise, –1.
        /// </returns>
        int IndexOf(TItem item, int startIndex = 0, int maximumCount = -1);

        /// <summary>
        /// Searches for the specified item and returns the zero-based index of the last occurrence within the range of items
        /// in the list that ends at the specified index and contains the specified number of items.
        /// </summary>
        /// <param name="item"> The item to locate in the list. The value can be <see langword="null" /> for reference types. </param>
        /// <param name="startIndex"> The zero-based starting index of the backward search. </param>
        /// <param name="maximumCount"> The number of elements in the section to search. </param>
        /// <returns>
        /// The zero-based index of the last occurrence of <paramref name="item" /> within the range of items in the
        /// list that ends at <paramref name="startIndex" /> and contains <paramref name="maximumCount" /> number of items, if
        /// found; otherwise, –1.
        /// </returns>
