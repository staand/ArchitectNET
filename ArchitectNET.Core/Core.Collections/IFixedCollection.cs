...
{
    /// <summary>
    /// Represents a generic unordered collection which does not provide any capabilities for external modification
    /// </summary>
    /// <typeparam name="TItem"> The type of the items in the collection. </typeparam>
    /// <remarks>
    /// The main reason of having custom interface instead of using standard <see cref="IReadOnlyCollection{T}" /> is a wish
