...
namespace ArchitectNET.Core.Collections.Support
{
    ...
    /// during equality check and also IGNORES duplicates (this means that sequance (a, b, b, c) is equal to (b, a, c) etc.).
    /// </summary>
    /// <typeparam name="TElement"> Type of elements which the compound key consists of. </typeparam>
    public sealed class UniqueCompoundKey<TElement> : IFixedCollection<TElement>,
                                                      IEquatable<UniqueCompoundKey<TElement>>,
                                                      ...
                                                      IEquatable<IEnumerable>
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="UniqueCompoundKey{TElement}" /> with the specified elements and equality
        /// comparer for them.
        /// </summary>
        /// <param name="elements">
        /// A sequence of elements which are to be copied to the new instance of <see cref="UniqueCompoundKey{TElement}" />.
        /// </param>
        ...
        /// </param>
        public UniqueCompoundKey(IEnumerable<TElement> elements, IEqualityComparer<TElement> equalityComparer = null)
        {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="UniqueCompoundKey{TElement}" /> with the specified elements.
        /// </summary>
        /// <param name="elements">
        /// An array of elements which are to be copied to the new instance of
        /// <see cref="UniqueCompoundKey{TElement}" />.
        /// </param>
        public UniqueCompoundKey(params TElement[] elements)
        ...
        /// <see cref="Equals(UniqueCompoundKey{TElement})" /> method.
        /// </summary>
        /// <param name="key1"> The first comparing <see cref="UniqueCompoundKey{TElement}" />. </param>
        /// <param name="key2"> The second comparing <see cref="UniqueCompoundKey{TElement}" />. </param>
        /// <returns>
        /// <see langword="true" /> if <paramref name="key1" /> is equal to <paramref name="key2" />, otherwise
        /// <see langword="false" />.
        /// </returns>
        public static bool operator ==(UniqueCompoundKey<TElement> key1, UniqueCompoundKey<TElement> key2)
        {
        ...
        public bool Equals(IEnumerable<TElement> otherElements)
        {
            if (otherElements == null)
                return false;
            var otherKey = otherElements as UniqueCompoundKey<TElement>;
            if (otherKey != null)
        ...
        /// returns an empty set; otherwise <see langword="false" />.
        /// </returns>
        public bool Equals(UniqueCompoundKey<TElement> otherKey)
        {
        ...
        /// <see cref="UniqueCompoundKey{TElement}" /> or of any other type which implements <see cref="IEnumerable{T}" /> or
        /// <see cref="IEnumerable" /> interface, have the same value.
        /// </summary>
        /// <param name="otherObject"> The object to compare to this instance. </param>
        /// <returns>
        /// <see langword="true" /> if <paramref name="otherObject" /> is an <see cref="UniqueCompoundKey{TElement}" /> or any
        ...
        /// </returns>
        /// <remarks>
        /// This method works in the same way as one of <see cref="Equals(UniqueCompoundKey{TElement})" />,
        ...
        /// <summary>
        /// Returns the hash code for this <see cref="UniqueCompoundKey{TElement}" />.
        /// </summary>
        ...
        /// <summary>
        /// Returns the string representation of this <see cref="UniqueCompoundKey{TElement}" />.
        /// </summary>
        /// <returns>
